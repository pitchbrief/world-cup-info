...
var OTHER_SVG = {
  ...
  // Closed padlock (wallchart locked status)
  ...
  // Open padlock (wallchart unlocked status)
  ...
  // Document icon for the Docs page
  ...
  // Monitor icon for the "Follow System" option
